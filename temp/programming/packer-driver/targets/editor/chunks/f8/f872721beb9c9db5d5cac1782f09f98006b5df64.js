    ...
    execute: function () {
      ...
      _export("LevelSettings", LevelSettings = (_dec = ccclass('LevelSettings'), _dec2 = property({
        ...
        applyLevelSettings() {
          ...
          const bossCPMultiplier = this.getBossMultiplier(this.bossInitialCombatPointMultiplier, isBossLevel);
          const bossAccuracyMultiplier = this.getBossMultiplier(this.bossDecisionAccuracyMultiplier, isBossLevel);
          const bossMaxWaveMultiplier = this.getBossMultiplier(this.bossMaxAliveWavesMultiplier, isBossLevel);
          ...
          if (this.allowCP && manager && manager.unitDatabase) {
            ...
            const cp = Math.round(baseCP * bossCPMultiplier);
