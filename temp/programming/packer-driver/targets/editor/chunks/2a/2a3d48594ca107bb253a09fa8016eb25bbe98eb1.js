  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && BattleUnitDatabase === void 0 ? (_reportPossibleCrUseOfBattleUnitDatabase({
        ...
        resetCombatPoint() {
          const aMax = this.unitDatabase ? this.unitDatabase.getMaxCombatPoint(0) : 0;
          const bMax = this.unitDatabase ? this.unitDatabase.getMaxCombatPoint(1) : 0;
        ...
        addCombatPointFromKill(killer, isCounterKill) {
          ...
          const entry = this.getRuntimeRewardEntry(killer, team);
          if (!entry) return;
        ...
        spawnWaveByEntry(team, entry) {
          ...
          const wave = this.spawnEntryFormation(team, entry, baseZ, true);
          this.rebuildSpatialGrid();
          return wave;
        }
