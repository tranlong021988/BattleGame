    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec3 = ccclass('GameManager'), _dec4 = property({
        ...
        spawnWaveForTeam(team, entries, spawnZ) {
          for (const entry of entries) {
            ...
            for (let i = 0; i < count; i++) {
              ...
              const z = spawnZ + this.randomRange(-this.spawnZJitter, this.spawnZJitter);
        ...
        spawnTeamA(unitName, pos) {
          ...
          const unit = this.spawner.spawnUnit(prefab, unitName, pos, 0, this.node);
        ...
        spawnTeamB(unitName, pos) {
          ...
          if (!prefab) return null;
          const unit = this.spawner.spawnUnit(prefab, unitName, pos, 1, this.node);
