    ...
    execute: function () {
      ...
      _export("SmartArmyBrain", SmartArmyBrain = (_dec = ccclass('SmartArmyBrain'), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        fillEnemyIntel(intel, wave, laneId) {
          ...
          const clearLaneScore = intel.allyCountInLane <= 0 && intel.allyBlockersFromSpawn <= 0 ? 20 : 0;
          const oneBlockerScore = intel.allyCountInLane > 0 && intel.allyBlockersFromSpawn === 1 ? 10 : 0;
