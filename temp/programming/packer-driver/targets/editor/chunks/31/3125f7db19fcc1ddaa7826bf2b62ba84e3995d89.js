    ...
    execute: function () {
      ...
      _export("Unit", Unit = (_dec = ccclass('Unit'), _dec2 = property(Node), _dec3 = property({
        ...
        reactToAttacker(attacker) {
          ...
          const regroupMeleeReengaged = !this.isolatedRangedPursuit && !!(gm != null && gm.isUnitAwaitingForwardRecovery(this)) && !!(gm != null && gm.tryReengageWaveFromRegroupMeleeAttack(this, attacker));
          ...
          const soloAggressive = gm ? gm.shouldUseSoloAggressiveSkirmish(this, attacker) : false; // Only a local engagement can interrupt recovery. A remote ranged hit
