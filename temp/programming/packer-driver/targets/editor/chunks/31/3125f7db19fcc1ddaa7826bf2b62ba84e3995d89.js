    ...
    execute: function () {
      ...
      _export("Unit", Unit = (_dec = ccclass('Unit'), _dec2 = property(Node), _dec3 = property({
        ...
        beginIsolatedRangedPursuitReturnToWaveLane(aggressiveForward) {
          ...
          this.backToLaneRecoveryCompleted = false;
          const parentWaveLaneId = (_instance$getAssigned = (_instance2 = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
        ...
        getTelemetryRegroupLaneCoreDistanceX() {
          ...
          const distanceFromCenter = Math.abs(this.agent.pos.x - gm.getLaneCenterX(targetLaneId));
        ...
        beginBackToLanePhase(aggressiveForward) {
          ...
          const started = this.startBackToLanePhase(aggressiveForward);
        ...
        reactToAttacker(attacker) {
          ...
          const isolateRangedPursuit = gm ? gm.shouldStartIsolatedRangedPursuit(this, attacker) : false; // A melee hit must be able to interrupt synchronized recovery even
          ...
          const regroupMeleeReengaged = !isolateRangedPursuit && !this.isolatedRangedPursuit && !!(gm != null && gm.isUnitAwaitingForwardRecovery(this)) && !!(gm != null && gm.tryReengageWaveFromRegroupMeleeAttack(this, attacker));
          ...
          const soloAggressive = gm ? gm.shouldUseSoloAggressiveSkirmish(this, attacker) : false; // A ranged hit outside the parent's strategic target set isolates this
        ...
        clearEnemy() {
          ...
          const forwardAggressive = (_instance6 = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
        ...
        startBackToLanePhase(aggressiveForward) {
          ...
          const dir = gm.getDirectionToLaneArea(targetLaneId, this.agent.pos.x);
        ...
        refreshRangedCombatMovement(target) {
          ...
          const dz = target.agent.pos.z - this.agent.pos.z;
          const dist = Math.sqrt(dx * dx + dz * dz);
          const range = Math.max(0.001, this.getEffectiveAttackRange(target.props.family));
