    ...
    execute: function () {
      ...
      _export("CounterSettings", CounterSettings = (_dec5 = ccclass('CounterSettings'), _dec6 = property({
        ...
        getDamageMultiplier(attackerFamily, defenderFamily) {
          var rule = this.findRule(attackerFamily, defenderFamily);
        ...
        calculateDamage(attacker, defender) {
          var damageMul = this.getDamageMultiplier(attacker.family, defender.family);
          var baseDamage = Math.max(1, attacker.damage - defender.defense);
        ...
        createDefaultRules() {
          ...
          this.addRule((_crd && UnitFamily === void 0 ? (_reportPossibleCrUseOfUnitFamily({
            ...
            error: Error()
          }), UnitFamily) : UnitFamily).Cavalry, hardCounter, 'Spear hard-counters Cavalry');
          this.addRule((_crd && UnitFamily === void 0 ? (_reportPossibleCrUseOfUnitFamily({
            error: Error()
