    ...
    execute: function () {
      ...
      _export("CounterSettings", CounterSettings = (_dec4 = ccclass('CounterSettings'), _dec5 = property({
        ...
        getDamageMultiplier(attackerType, defenderType) {
          var rule = this.findRule(attackerType, defenderType);
        ...
        calculateDamage(attacker, defender) {
          var damageMul = this.getDamageMultiplier(attacker.unitType, defender.unitType);
          var receivedMul = this.getReceivedDamageMultiplier(attacker.unitType, defender.unitType);
          var rawDamage = attacker.damage * damageMul * receivedMul;
          var finalDamage = Math.max(1, rawDamage - defender.defense);
          return finalDamage;
        }
...
//# sourceMappingURL=dee523ab7ec709183fc95a30a4777390f6d5b637.js.map