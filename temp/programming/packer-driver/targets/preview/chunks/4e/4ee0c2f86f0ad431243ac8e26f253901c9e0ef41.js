    ...
    execute: function () {
      ...
      _export("BattleCardRuntime", BattleCardRuntime = class BattleCardRuntime {
        ...
        getModifiers(team, family, opposingFamily) {
          ...
          var cacheKey = safeTeam + ":" + family + ":" + (opposingFamily === undefined ? '*' : opposingFamily);
        ...
        consumeModifier(team, family, modifier, opposingFamily) {
          var cards = this.cardsByTeam[this.clampTeam(team)];
          var consumed = false;
...
//# sourceMappingURL=4ee0c2f86f0ad431243ac8e26f253901c9e0ef41.js.map