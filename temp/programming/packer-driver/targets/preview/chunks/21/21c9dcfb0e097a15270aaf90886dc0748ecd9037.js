    ...
    execute: function () {
      ...
      _export("SpawnBackPressureGate", SpawnBackPressureGate = (_dec = ccclass('SpawnBackPressureGate'), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        updateFps(deltaTime) {
          ...
          var instantFps = 1 / deltaTime;
          var t = 1 - Math.exp(-this.fpsSmooth * deltaTime);
        ...
        evaluateSpawnPressure(checkDeltaTime) {
          ...
          if (this.paused) {
            var canResumeByFps = !this.enableFpsGate || this.smoothedFps >= this.minFpsToSpawn;
            var canResumeByUnits = !this.enableAliveUnitGate || aliveUnits <= this.resumeAliveUnits;
            var canResumeByWaves = !this.enableWaveGate || aliveWaves <= this.resumeAliveWaves;
            var canResume = this.pauseTimer <= 0 && canResumeByFps && canResumeByUnits && canResumeByWaves;
        ...
        getAliveUnitCount() {
          ...
          if (typeof gm.getAliveUnits === 'function') {
            var a = gm.getAliveUnits(0) || [];
            var b = gm.getAliveUnits(1) || [];
        ...
        getAliveWaveCount() {
          ...
          for (var i = 0; i < gm.waves.length; i++) {
            var wave = gm.waves[i];
            if (!wave) continue;
...
//# sourceMappingURL=21c9dcfb0e097a15270aaf90886dc0748ecd9037.js.map