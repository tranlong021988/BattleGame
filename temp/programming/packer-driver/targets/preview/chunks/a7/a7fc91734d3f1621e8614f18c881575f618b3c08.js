System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function createCard(id, displayName, purchasePrice, baseCooldownBattles, baseBudget, target, targetFamily, modifier, modifierValue, tradeoffModifier, tradeoffValue, requiredEnemyFamily, enemyPool, baseStrengthScale, strengthUpgradeMaxRank) {
    if (tradeoffModifier === void 0) {
      tradeoffModifier = BattleCardModifier.None;
    }

    if (tradeoffValue === void 0) {
      tradeoffValue = 0;
    }

    if (requiredEnemyFamily === void 0) {
    ...
    if (baseStrengthScale === void 0) {
      baseStrengthScale = 1;
    }

    if (strengthUpgradeMaxRank === void 0) {
      strengthUpgradeMaxRank = 0;
    }

    var card = new BattleCardDefinition();
    card.id = id;
...
//# sourceMappingURL=a7fc91734d3f1621e8614f18c881575f618b3c08.js.map