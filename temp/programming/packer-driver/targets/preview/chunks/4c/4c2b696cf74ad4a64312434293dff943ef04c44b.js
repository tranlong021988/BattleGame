    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && BattleUnitDatabase === void 0 ? (_reportPossibleCrUseOfBattleUnitDatabase({
        ...
        processBattleWinnerCondition() {
          ...
          var loserTeam = !teamACanSpawn && !teamBCanSpawn ? -1 : teamACanSpawn ? 1 : 0;
          var winnerTeam = loserTeam < 0 ? -1 : loserTeam === 0 ? 1 : 0;
          var reason = 'first-team-cannot-afford-any-spawn';
        ...
        resolveBattleWinner(winnerTeam, loserTeam, reason) {
          ...
          var shouldDownloadSingleReport = this.downloadBattleTelemetryOnEnd && (!this.reloadPageAfterBattleTelemetryExport || this.downloadSingleTelemetryDuringAutoReload);
        ...
        storeBattleTelemetryReportInBrowser(report) {
          ...
          var key = this.battleTelemetryStorageKey || 'battle-telemetry-batch';

          try {
            var existingText = localStorage.getItem(key);
            var reports = existingText ? JSON.parse(existingText) : [];
