System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && BattleUnitDatabase === void 0 ? (_reportPossibleCrUseOfBattleUnitDatabase({
      ...
      }), _dec24 = property(Node), _dec25 = property(Node), _dec26 = property(Label), _dec27 = property(Label), _dec28 = property(Label), _dec29 = property(Label), _dec30 = property(Label), _dec31 = property(Label), _dec32 = property(Label), _dec33 = property(Label), _dec34 = property(Label), _dec35 = property(Label), _dec36 = property({
        min: 1,
        tooltip: 'Frames between safety wave-banner holder refresh checks. Set to 1 to refresh every frame.'
      }), _dec37 = property(Camera), _dec38 = property({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "redHeroLine", _descriptor28, this);

          _initializerDefineProperty(this, "blueHeroLine", _descriptor29, this);

          _initializerDefineProperty(this, "updateInterval", _descriptor30, this);

          _initializerDefineProperty(this, "rvoUpdateFrameOffset", _descriptor31, this);

          _initializerDefineProperty(this, "maxRvoStepDeltaTime", _descriptor32, this);

          this.frame = 0;

          _initializerDefineProperty(this, "visualSmooth", _descriptor33, this);

          _initializerDefineProperty(this, "spatialGridCellSize", _descriptor34, this);

          _initializerDefineProperty(this, "spatialGridUpdateInterval", _descriptor35, this);

          _initializerDefineProperty(this, "spatialGridUpdateFrameOffset", _descriptor36, this);

          _initializerDefineProperty(this, "useWorkerSpatialTargetQuery", _descriptor37, this);
          ...
          _initializerDefineProperty(this, "teamAAliveLabel", _descriptor38, this);

          _initializerDefineProperty(this, "teamADeathLabel", _descriptor39, this);

          _initializerDefineProperty(this, "teamBAliveLabel", _descriptor40, this);

          _initializerDefineProperty(this, "teamBDeathLabel", _descriptor41, this);

          _initializerDefineProperty(this, "teamAKillLabel", _descriptor42, this);

          _initializerDefineProperty(this, "teamBKillLabel", _descriptor43, this);

          _initializerDefineProperty(this, "teamACounterKillLabel", _descriptor44, this);

          _initializerDefineProperty(this, "teamBCounterKillLabel", _descriptor45, this);

          _initializerDefineProperty(this, "teamACombatPointLabel", _descriptor46, this);

          _initializerDefineProperty(this, "teamBCombatPointLabel", _descriptor47, this);
          ...
          _initializerDefineProperty(this, "enableAutoSpawn", _descriptor48, this);

          _initializerDefineProperty(this, "spawnImmediatelyOnStart", _descriptor49, this);

          _initializerDefineProperty(this, "prewarmOnStart", _descriptor50, this);

          _initializerDefineProperty(this, "spawnWaveInterval", _descriptor51, this);

          _initializerDefineProperty(this, "maxAutoSpawnDeltaTime", _descriptor52, this);

          _initializerDefineProperty(this, "teamASpawnZ", _descriptor53, this);

          _initializerDefineProperty(this, "teamBSpawnZ", _descriptor54, this);

          _initializerDefineProperty(this, "formationZNoise", _descriptor55, this);

          _initializerDefineProperty(this, "centerGapWidth", _descriptor56, this);

          _initializerDefineProperty(this, "enableLaneSpawn", _descriptor57, this);

          _initializerDefineProperty(this, "laneCount", _descriptor58, this);

          _initializerDefineProperty(this, "defaultSpawnLane", _descriptor59, this);

          _initializerDefineProperty(this, "autoSpawnRandomLane", _descriptor60, this);

          _initializerDefineProperty(this, "waveBannerRefreshIntervalFrames", _descriptor61, this);

          _initializerDefineProperty(this, "waveBannerCamera", _descriptor62, this);

          _initializerDefineProperty(this, "enableWaveBannerCameraVisibility", _descriptor63, this);

          _initializerDefineProperty(this, "hideWaveBannerInOrbitMode", _descriptor64, this);

          _initializerDefineProperty(this, "waveBannerHideFovBelow", _descriptor65, this);

          _initializerDefineProperty(this, "waveBannerShowFovAbove", _descriptor66, this);

          this.spawnWaveTimer = 0;

          _initializerDefineProperty(this, "circleObstacles", _descriptor67, this);

          _initializerDefineProperty(this, "rectObstacles", _descriptor68, this);
          ...
          this.refreshLaneBeforeWaveForward = wave => {
            ...
            var previousLaneId = wave.laneId;
          ...
          this.manualBattleStartEnabled = false;
        ...
        setManualBattleStartEnabled(enabled) {
          this.manualBattleStartEnabled = enabled;
        }

        isWaitingForPlayerStart() {
          return this.manualBattleStartEnabled && !this.battleRuntimeActive;
        }
        ...
        releaseBattleUnits(units) {
          for (var i = 0; i < units.length; i++) {
            ...
            var entry = this.getTeamEntry(unit.team, unit.unitTypeName);
        ...
        destroyStaleRuntimeUnits() {
          var root = this.battleRuntimeRoot;
          if (!root || !root.isValid) return;
          var units = root.getComponentsInChildren(_crd && Unit === void 0 ? (_reportPossibleCrUseOfUnit({
            error: Error()
          }), Unit) : Unit);
        ...
        resetBattleRuntimeComponents() {
          ...
          if (!scene) return;
          var components = scene.getComponentsInChildren(Component);

          for (var i = 0; i < components.length; i++) {
            var component = components[i];
            var reset = component == null ? void 0 : component.resetForNewBattle;
        ...
        update(deltaTime) {
          ...
          var frameDeltaMs = deltaTime * 1000;
          var captureFrameHitch = this.enableBattleTelemetry && this.battleTelemetry.isEnabled() && Number.isFinite(frameDeltaMs) && frameDeltaMs >= this.telemetryFrameHitchThresholdMs;
          var managerUpdateStart = captureFrameHitch || this.shouldSampleBattleManagerUpdate() ? this.getPerformanceNow() : -1;
          ...
          if (managerUpdateStart >= 0) {
            var elapsed = this.getPerformanceNow();

            if (elapsed >= managerUpdateStart) {
              var managerUpdateMs = elapsed - managerUpdateStart;
        ...
        resetBattleFramePerformanceTelemetry() {
          for (var i = 0; i < this.telemetryFrameDeltaHistogram.length; i++) {
        ...
        recordBattleFrameDelta(deltaTime) {
          ...
          var histogramIndex = Math.max(0, Math.min(this.telemetryFrameDeltaHistogram.length - 1, Math.floor(milliseconds)));
        ...
        getPerformanceNow() {
          var timing = globalThis.performance;
        ...
        getBattleFrameDeltaPercentile(percentile) {
          ...
          var target = Math.max(1, Math.ceil(this.telemetryFrameSampleCount * percentile));
          var accumulated = 0;
        ...
        recordBattleFramePerformanceSummary() {
          var frameCount = this.telemetryFrameSampleCount;
        ...
        configureBattleCardDecks(playerCardIds, enemyCardIds, playerBudgetUpgradeLevels, playerStrengthScales, enemyStrengthScales, maxPlayerCards, maxEnemyCards) {
        ...
        resolveUnitReachedEnemyHeroLine(unit) {
          ...
          var defendingTeam = unit.team === 0 ? 1 : 0;
          var defendingHero = defendingTeam === 0 ? this.teamAHero : this.teamBHero;
        ...
        cashOutWaveAtEnemyHeroLine(wave, scanner) {
          var aliveUnitCount = wave.getAliveCount();
          if (aliveUnitCount <= 0) return;
          var physicalLaneId = this.getCurrentLaneIdForUnit(scanner);
          var laneId = physicalLaneId >= 0 ? physicalLaneId : wave.laneId;
          var laneState = this.getBreakthroughLaneState(scanner.team, laneId);
          var originalCombatPointCost = Math.max(0, wave.originalCombatPointCost);
          var rewardMultiplier = aliveUnitCount >= wave.totalCount ? 2 : 1;
          var rewardCombatPoint = originalCombatPointCost * rewardMultiplier;
          var combatPointBeforeReward = this.combatPoint[scanner.team] || 0;
          var combatPointAfterReward = combatPointBeforeReward + rewardCombatPoint;
          var laneKey = scanner.team + ":" + laneId;
          var laneBreakthroughSequence = (this.breakthroughLaneSequences.get(laneKey) || 0) + 1;
          var previousBreakthroughIdInLane = this.lastBreakthroughIdByLane.get(laneKey);
          var cashout = {
            id: wave.id,
            frame: this.frame,
            time: this.battleElapsedTime,
        ...
        getBreakthroughLaneState(attackingTeam, laneId) {
          var attackingNonHeroAlive = 0;
          var defendingNonHeroAlive = 0;
          var attackingWaveIds = new Set();
          var defendingWaveIds = new Set();

          var collect = units => {
            for (var i = 0; i < units.length; i++) {
              var laneUnit = units[i];
              ...
              var laneWave = (_crd && BattleWave === void 0 ? (_reportPossibleCrUseOfBattleWave({
                error: Error()
        ...
        recordUnitReachedEnemyHeroLineContext(unit) {
          ...
          var physicalLaneId = this.getCurrentLaneIdForUnit(unit);
          var defendingTeam = unit.team === 0 ? 1 : 0;
          var unitPosition = unit.agent ? unit.agent.pos : unit.node.worldPosition;
          var heroLineZ = this.heroLineZ[defendingTeam];
          var forwardZ = unit.forwardDir.z;
          var laneOwnNonHeroAlive = 0;
          var laneEnemyNonHeroAlive = 0;
          var laneOwnWaveIds = new Set();
          var laneEnemyWaveIds = new Set();

          var countLaneUnits = units => {
            for (var i = 0; i < units.length; i++) {
              var laneUnit = units[i];
              if (!this.isAliveUnit(laneUnit)) continue;
              if (laneUnit.isHero) continue;
        ...
        recordHeroDefeatTelemetryContext(hero) {
          ...
          var heroWave = (_crd && BattleWave === void 0 ? (_reportPossibleCrUseOfBattleWave({
            error: Error()
          }), BattleWave) : BattleWave).getWaveForUnit(hero);
          var heroLaneId = heroWave ? heroWave.laneId : this.getHeroLaneId();
          var guardRadius = Math.max(0, hero.heroGuardDistance);
          var nearbyRadius = Math.max(0.01, guardRadius);
          var nearbyRadiusSquared = nearbyRadius * nearbyRadius;
          var heroPosition = hero.node.worldPosition;

          var collect = team => {
            var units = this.getAliveUnits(team);
            var alive = 0;
            var nearHero = 0;
            var inHeroLane = 0;
            ...
            for (var i = 0; i < units.length; i++) {
              ...
              alive++;
              var position = unit.node.worldPosition;
              var dx = position.x - heroPosition.x;
              var dz = position.z - heroPosition.z;
          ...
          var allies = collect(heroTeam);
          var enemies = collect(enemyTeam);
        ...
        onWaveCombatStarted(unit, enemy, useInitialForwardGate) {
          ...
          var aggressiveForwardBefore = wave.isAggressiveForwardMode();
          var sameLaneWaveEngagement = this.isSameLaneWaveEngagement(wave, enemy);
          var crossLaneRangedAttack = this.isCrossLaneRangedAttack(unit, enemy);
          var strategicEscalationBlocked = crossLaneRangedAttack && !wave.hasEngagedTargetWave((_crd && BattleWave === void 0 ? (_reportPossibleCrUseOfBattleWave({
            error: Error()
          }), BattleWave) : BattleWave).getWaveForUnit(enemy));
          var canEscalateWaveCombat = !strategicEscalationBlocked && !soloAggressiveCombat && (!wave.hasAggressiveForwardLaneLock() || sameLaneWaveEngagement && aggressiveFrontlineEngagement) && this.canEscalateWaveCombatFromEngagement(wave, enemy);
          var strategicEngagedCount = canEscalateWaveCombat ? this.getForwardStrategicEngagedCount(wave, unit, enemy, aggressiveForwardBefore) : 0;
          var strategicEngagementThreshold = Math.ceil(wave.getCommandAliveCount() / 2);
          var initialForwardCombatDelayed = canEscalateWaveCombat && this.shouldDelayInitialForwardCombat(wave, unit, enemy, useInitialForwardGate);
          var waveCombatEscalated = canEscalateWaveCombat && !initialForwardCombatDelayed && waveForwardBefore;
          ...
          var enemyAggressiveFrontlineEngagement = this.isAggressiveFrontlineEngagement(enemyWave, enemy, unit);
          var enemySoloAggressiveCombat = this.shouldUseSoloAggressiveCombat(enemyWave, enemy, unit, enemyAggressiveFrontlineEngagement);
          var enemyWaveForwardBefore = enemyWave.isForwardMode();
          var enemyAggressiveForwardBefore = enemyWave.isAggressiveForwardMode();
          var enemySameLaneWaveEngagement = this.isSameLaneWaveEngagement(enemyWave, unit);
          var enemyStrategicEscalationBlocked = crossLaneRangedAttack && !enemyWave.hasEngagedTargetWave(wave) || this.isRemoteRangedAttackAgainstMelee(unit, enemy);
          var enemyCanEscalateWaveCombat = !enemyStrategicEscalationBlocked && !enemySoloAggressiveCombat && (!enemyWave.hasAggressiveForwardLaneLock() || enemySameLaneWaveEngagement && enemyAggressiveFrontlineEngagement) && this.canEscalateWaveCombatFromEngagement(enemyWave, unit);
          var enemyStrategicEngagedCount = enemyCanEscalateWaveCombat ? this.getForwardStrategicEngagedCount(enemyWave, enemy, unit, enemyAggressiveForwardBefore) : 0;
          var enemyStrategicEngagementThreshold = Math.ceil(enemyWave.getCommandAliveCount() / 2);
          var enemyInitialForwardCombatDelayed = enemyCanEscalateWaveCombat && this.shouldDelayInitialForwardCombat(enemyWave, enemy, unit, useInitialForwardGate);
          var enemyWaveCombatEscalated = enemyCanEscalateWaveCombat && !enemyInitialForwardCombatDelayed && enemyWaveForwardBefore;
        ...
        finishIsolatedRangedPursuit(unit, previousTarget) {
          ...
          if (!wave || wave.isDead()) return false;
          var wasReturningToWave = unit.isReturningToWaveAfterIsolatedRangedPursuit(); // clearInvalidEnemy() runs every frame while a detached unit has no
          ...
          var returningToWaveLane = unit.beginIsolatedRangedPursuitReturnToWaveLane(wave.hasAggressiveForwardLaneLock());
        ...
        completeIsolatedRangedPursuitReturnToWaveLane(unit, arrivedLaneId) {
          ...
          var currentWaveLaneId = wave.laneId;
        ...
        recordIsolatedRangedPursuit(type, unit, target) {
          ...
          var physicalLaneId = this.getCurrentLaneIdForUnit(unit);
          var waveLaneDistance = wave && wave.laneId >= 0 && physicalLaneId >= 0 ? Math.abs(this.clampLaneId(wave.laneId) - this.clampLaneId(physicalLaneId)) : -1;
          this.battleTelemetry.recordDiagnosticEvent({
            type,
            frame: this.frame,
            time: this.battleElapsedTime,
        ...
        recordWaveRegroupTransition(type, unit, attacker) {
          var _attacker, _attacker2, _attackerWave$id, _attacker$team, _attacker3, _attackerWave$laneId, _attacker$lifeId, _attacker4, _attackerPosition$x, _attackerPosition$z;
          ...
          var unitPosition = unit.agent ? unit.agent.pos : unit.node.worldPosition;
          var attackerPosition = (_attacker = attacker) != null && _attacker.agent ? attacker.agent.pos : (_attacker2 = attacker) == null ? void 0 : _attacker2.node.worldPosition;
          this.battleTelemetry.recordDiagnosticEvent({
            type,
            frame: this.frame,
            time: this.battleElapsedTime,
            ...
            targetTeam: (_attacker$team = (_attacker3 = attacker) == null ? void 0 : _attacker3.team) != null ? _attacker$team : -1,
            targetLaneId: (_attackerWave$laneId = attackerWave == null ? void 0 : attackerWave.laneId) != null ? _attackerWave$laneId : -1,
            targetLifeId: (_attacker$lifeId = (_attacker4 = attacker) == null ? void 0 : _attacker4.lifeId) != null ? _attacker$lifeId : -1,
        ...
        trySetWaveTargetFromScanner(wave, scanner, target, source, allowRecoveryContinuation) {
          ...
          var previousTargetWaveIds = wave.getTargetWaveIds();
          var previousTargetWaveId = (_previousTargetWaveId = previousTargetWaveIds[0]) != null ? _previousTargetWaveId : -1;
          var candidateWave = (_crd && BattleWave === void 0 ? (_reportPossibleCrUseOfBattleWave({
            error: Error()
          }), BattleWave) : BattleWave).getWaveForUnit(target);
          var wasAlreadyAssigned = wave.hasEngagedTargetWave(candidateWave);
          var assigned = wave.trySetTargetWaveFromScanner(scanner, target, allowRecoveryContinuation);
        ...
        trySetWaveTargetFromEngagement(wave, unit, target) {
          ...
          var previousTargetWaveIds = wave.getTargetWaveIds();
          var previousTargetWaveId = (_previousTargetWaveId2 = previousTargetWaveIds[0]) != null ? _previousTargetWaveId2 : -1;
          var candidateWave = (_crd && BattleWave === void 0 ? (_reportPossibleCrUseOfBattleWave({
            error: Error()
          }), BattleWave) : BattleWave).getWaveForUnit(target);
          var wasAlreadyAssigned = wave.hasEngagedTargetWave(candidateWave);
          var assigned = wave.trySetTargetWaveFromEngagement(unit, target);
        ...
        recordWaveCombatEscalationDecision(wave, unit, target, aggressiveForwardBefore, waveForwardBefore, sameLaneWaveEngagement, soloAggressiveCombat, aggressiveFrontlineEngagement, canEscalateWaveCombat, initialForwardCombatDelayed, waveCombatEscalated, crossLaneRangedAttack, strategicEscalationBlocked, engagementRole, strategicEngagedCount, strategicEngagementThreshold) {
          ...
          if (crossLaneRangedAttack === void 0) {
            crossLaneRangedAttack = false;
          }

          if (strategicEscalationBlocked === void 0) {
            strategicEscalationBlocked = false;
          }

          if (engagementRole === void 0) {
            engagementRole = 'attacker';
          }

          if (strategicEngagedCount === void 0) {
            strategicEngagedCount = 0;
          }

          if (strategicEngagementThreshold === void 0) {
            strategicEngagementThreshold = 0;
          }
          ...
          var signature = [(_targetWave$id3 = targetWave == null ? void 0 : targetWave.id) != null ? _targetWave$id3 : -1, aggressiveForwardBefore, waveForwardBefore, sameLaneWaveEngagement, soloAggressiveCombat, aggressiveFrontlineEngagement, canEscalateWaveCombat, initialForwardCombatDelayed, waveCombatEscalated, crossLaneRangedAttack, strategicEscalationBlocked, engagementRole, strategicEngagedCount, strategicEngagementThreshold].join('|');
        ...
        recordWaveTargetAssignment(wave, unit, target, previousTargetWaveId, source, assigned, wasAlreadyAssigned, previousTargetWaveIds) {
          ...
          var assignmentState = wave.getTargetAssignmentTelemetryState();
          this.closeWaveIdleEpisode(wave, 'target-assigned');
          this.battleTelemetry.recordTargetWaveTransition(_extends({
        ...
        recordWaveForwardResume(wave, source) {
          var _wave$family2;
        ...
        recordWaveForwardRecoveryDeferred(wave, state) {
          ...
          if (!this.enableBattleTelemetry) return;
          this.battleTelemetry.recordTargetWaveLifecycleEvent(_extends({
        ...
        recordUnitIdleWithoutOrder(unit) {
          ...
          if (!wave) return;
          var targetWave = wave.getTargetWave();
          var targetWaveIds = wave.getTargetWaveIds();
          var existingEpisode = this.telemetryIdleEpisodes.get(wave.id);
        ...
        closeWaveIdleEpisode(wave, reason) {
          var episode = this.telemetryIdleEpisodes.get(wave.id);
          if (!episode) return;
        ...
        closeTargetClearRecoveryWindow(wave, reason) {
          ...
          var recoveryWindow = this.telemetryTargetClearRecoveryWindows.get(wave.id);
        ...
        recordWaveTargetClearOutcome(wave, outcome) {
          ...
          if (!recoveryWindow) return;
          var targetLaneId = (_targetWave$laneId6 = targetWave == null ? void 0 : targetWave.laneId) != null ? _targetWave$laneId6 : -1;
          var offLaneReplacement = targetLaneId >= 0 && recoveryWindow.clearedTargetLaneId >= 0 && targetLaneId !== recoveryWindow.clearedTargetLaneId;
          this.battleTelemetry.recordTargetWaveLifecycleEvent({
        ...
        recordWaveScannerTrace(scanner, observedUnit, source, reason, targetWaveBefore, observedEnemyCount, searchSameLaneOnly) {
          ...
          if (observedEnemyCount === void 0) {
            observedEnemyCount = 0;
          }

          if (searchSameLaneOnly === void 0) {
            searchSameLaneOnly = false;
          }
          ...
          var targetWaveAfter = wave.getTargetWave();
          var observedWave = (_ref2 = (_getWaveForUnit = (_crd && BattleWave === void 0 ? (_reportPossibleCrUseOfBattleWave({
            error: Error()
          }), BattleWave) : BattleWave).getWaveForUnit(observedUnit)) != null ? _getWaveForUnit : targetWaveAfter) != null ? _ref2 : targetWaveBefore;
          var observed = (_ref3 = observedUnit != null ? observedUnit : observedWave == null ? void 0 : observedWave.getRepresentativeUnit()) != null ? _ref3 : null;
          var scannerPosition = scanner.agent ? scanner.agent.pos : scanner.node.worldPosition;
          var observedPosition = observed != null && observed.agent ? observed.agent.pos : observed == null ? void 0 : observed.node.worldPosition;
          var prefVelocity = (_scanner$agent = scanner.agent) == null ? void 0 : _scanner$agent.prefVel;
        ...
        shouldUseSoloAggressiveCombat(wave, unit, enemy, aggressiveFrontlineEngagement) {
          if (aggressiveFrontlineEngagement === void 0) {
            aggressiveFrontlineEngagement = this.isAggressiveFrontlineEngagement(wave, unit, enemy);
          }
          ...
          var unitLane = wave.laneId;
          var enemyWave = (_crd && BattleWave === void 0 ? (_reportPossibleCrUseOfBattleWave({
            error: Error()
          }), BattleWave) : BattleWave).getWaveForUnit(enemy);
          var enemyLane = enemyWave ? enemyWave.laneId : -1;
        ...
        isAggressiveFrontlineEngagement(wave, unit, enemy) {
          if (enemy === void 0) {
            enemy = null;
          }
          ...
          var scanner = wave.getScanner(true); // The contact unit leaves Forward before this callback. When it was
          ...
          var dx = unit.agent.pos.x - scanner.agent.pos.x;
          var dz = unit.agent.pos.z - scanner.agent.pos.z;
          var forwardProgress = dx * scanner.forwardDir.x + dz * scanner.forwardDir.z; // Progress zero is the scanner's forward line, so a unit abreast of
        ...
        shouldDelayInitialForwardCombat(wave, unit, enemy, useInitialForwardGate) {
          ...
          var aliveCount = wave.getCommandAliveCount();
          var threshold = Math.ceil(aliveCount / 2);
          if (threshold <= 1) return false;
          var engagedCount = this.getForwardStrategicEngagedCount(wave, unit, enemy, wave.isAggressiveForwardMode());
        ...
        getNormalStrategicEngagedCount(wave, pendingUnit, pendingEnemy) {
          ...
          for (var i = 0; i < wave.units.length; i++) {
            var unit = wave.units[i];
            var isPending = unit === pendingUnit;
            if (!wave.isCommandUnit(unit)) continue;
            if (!isPending && !unit.onBusy) continue;
            var enemy = isPending ? pendingEnemy : unit.getValidEnemyTarget();
            if (!enemy) continue;
        ...
        getAggressiveFrontlineEngagedCount(wave, pendingUnit, pendingEnemy) {
          ...
          for (var i = 0; i < wave.units.length; i++) {
            var unit = wave.units[i];
            var isPending = unit === pendingUnit; // Pooled Unit objects can already belong to a newer wave while
        ...
        onWaveForwardTargetFound(unit, target, source, allowRecoveryContinuation) {
          if (source === void 0) {
        ...
        tryPrimeSharedWaveHuntTargetAfterCombatEnd(unit) {
          ...
          var target = wave.findSharedTargetForUnit(unit);
        ...
        searchForwardWaveTarget(wave, forceScannerPassCheck) {
          if (forceScannerPassCheck === void 0) {
            forceScannerPassCheck = false;
          }
          ...
          if (aggressiveForward) {
            ...
            var _targetWaveBefore = wave.getTargetWave();

            var _target = this.findPassedEnemyWaveScanner(wave, scanner, true);

            var released = _target ? this.onWaveForwardTargetFound(scanner, _target) : false;

            if (released) {
              this.recordAggressiveForwardEvent('aggressive-scanner-pass-release', wave, scanner, _target, 0, 'same-lane-scanner-passed-target');
            }
            ...
            this.recordWaveScannerTrace(scanner, _target != null ? _target : adjacentRearGuard, forceScannerPassCheck ? 'forward-aggressive-recovery-resume' : 'forward-aggressive', _target ? 'target-passed-release' : enemiesAhead > 0 ? 'own-lane-blocked' : adjacentRearGuard ? 'lane-clear-adjacent-flank' : 'lane-clear', _targetWaveBefore, (_target ? 1 : 0) + enemiesAhead + (adjacentRearGuard ? 1 : 0), true);
            if (_target) return;
          ...
          scanner = wave.getScanner(true);
          if (!scanner) return;
          var targetWaveBefore = wave.getTargetWave();
          var target = this.findPassedEnemyWaveScanner(wave, scanner, false);
          var releasesTarget = !!target;
        ...
        tryResumeWaveForwardFromLocalCombatEnd(unit) {
          ...
          var recoveryResult = this.tryFinishWaveForwardRecovery(wave, 'local-combat-ended');
        ...
        tryFinishWaveForwardRecovery(wave, forwardResumeSource) {
          if (forwardResumeSource === void 0) {
            forwardResumeSource = 'target-set-empty';
          }

          var completed = wave.tryResumeForward(this.refreshLaneBeforeWaveForward, readyWave => this.tryContinueRecoveryFreeHuntBeforeForward(readyWave));
        ...
        tryContinueRecoveryFreeHuntBeforeForward(wave) {
          ...
          var sameLaneOnly = wave.hasAggressiveForwardLaneLock();
          var targetWaveBefore = wave.getTargetWave();
          var target = this.findPassedEnemyWaveScanner(wave, scanner, sameLaneOnly);
          var released = target ? this.onWaveForwardTargetFound(scanner, target, 'recovery-pre-forward-scanner-pass', true) : false;
        ...
        findPassedEnemyWaveScanner(wave, scanner, sameLaneOnly) {
          ...
          var maxRange = Math.max(0, scanner.targetSearchRange);
          ...
          for (var i = 0; i < this.waves.length; i++) {
            ...
            var laneDistance = Math.abs(enemyLane - ownLane);
            ...
            var dx = enemyScanner.agent.pos.x - scanner.agent.pos.x;
            var dz = enemyScanner.agent.pos.z - scanner.agent.pos.z;
            var distSq = dx * dx + dz * dz;
        ...
        processWaveForwardRecoveries() {
          for (var i = 0; i < this.waves.length; i++) {
            ...
            var recoveryResult = this.tryFinishWaveForwardRecovery(wave);

            if (recoveryResult !== 'blocked') {
              continue;
            }

            var blocker = wave.consumeForwardRecoveryBlockTelemetry();

            if (blocker) {
              this.recordWaveForwardRecoveryBlocked(wave, blocker);
            }

            var deferred = wave.consumeForwardRecoveryDeferredTelemetry();
        ...
        refreshDynamicLaneForWave(wave) {
          ...
          var scanner = wave.getScanner();
          if (!scanner) return;
          var scannerX = scanner.agent ? scanner.agent.pos.x : scanner.node.worldPosition.x;
          var laneId = this.getNearestLaneIdForX(scannerX);
        ...
        tryUnlockHeroForward(team) {
          ...
          var laneSelection = this.getHeroSupportLaneSelection(team);
          var hero = this.activateHeroForTeam(team, laneSelection.laneId, laneSelection.unitsPerLane);
        ...
        processWaveTargetClearTelemetry() {
          for (var i = 0; i < this.waves.length; i++) {
            ...
            var previousLaneId = wave.laneId;
            var pending = wave.processPendingTargetLifecycle();
        ...
        flushWaveTargetClearTelemetry(wave) {
          var clearedTarget = wave.consumeClearedTargetTelemetry();
          ...
          var targetClearOutcome = wave.consumeTargetClearOutcomeTelemetry();
        ...
        unlockHeroForward(team, hero, laneId) {
          ...
          if (heroWave) {
            var previousLaneId = heroWave.laneId;
        ...
        createBattleTelemetryWaveSnapshot(wave, includeUnits) {
          ...
          var forwardCount = 0;
          var isolatedRangedPursuitCount = 0;
          var staleUnitReferenceCount = 0;
          var maxPhysicalLaneDistance = 0;
          var units = [];
          ...
          for (var i = 0; i < wave.units.length; i++) {
            ...
            var position = unit.agent ? unit.agent.pos : unit.node.worldPosition;
            var physicalLaneId = this.getCurrentLaneIdForUnit(unit);
            var waveLaneDistance = wave.laneId >= 0 && physicalLaneId >= 0 ? Math.abs(this.clampLaneId(wave.laneId) - this.clampLaneId(physicalLaneId)) : -1;
            var target = unit.getValidEnemyTarget();
            var targetWave = (_crd && BattleWave === void 0 ? (_reportPossibleCrUseOfBattleWave({
              error: Error()
            }), BattleWave) : BattleWave).getWaveForUnit(target);
          ...
          var scanner = wave.getScanner();
          var scannerPosition = scanner != null && scanner.agent ? scanner.agent.pos : scanner == null ? void 0 : scanner.node.worldPosition;
          return _extends({
            waveId: wave.id,
            team: wave.team,
            laneId: wave.laneId,
        ...
        haltAllUnitsForBattleEnd() {
          var units = this.teamA.concat(this.teamB);
        ...
        notifyUnitWillDespawn(unit) {
          ...
          if (wave) {
            var targetPhysicalLaneId = this.getPhysicalLaneIdForWave(wave);
            wave.invalidateRuntimeState();
        ...
        markTargetLifecyclePendingForWave(targetWave, reason, targetPhysicalLaneId) {
          if (targetPhysicalLaneId === void 0) {
            targetPhysicalLaneId = -1;
          }
          ...
          for (var i = 0; i < this.waves.length; i++) {
            ...
            var marked = wave.markTargetLifecyclePending(this.frame, targetWave, reason, targetPhysicalLaneId);
        ...
        prewarmAllUnits() {
          var teamAEntries = this.getDatabaseTeamEntries(0);
          var teamBEntries = this.getDatabaseTeamEntries(1);
          var runtimeRoot = this.getBattleRuntimeRoot();
          ...
          for (var _entry2 of teamBEntries) {
            ...
            this.spawner.prewarm(_entry2.prefab, _entry2.prewarmCount, runtimeRoot);
          }
        }
        ...
        getBattleRuntimeRoot() {
          ...
          var nextRoot = new Node('BattleRuntime');
        ...
        linkPendingBreakthroughCashoutsToSpawn(team, wave, entry, cost) {
          ...
          for (var i = 0; i < this.pendingBreakthroughSpawnLinks.length; i++) {
            var pending = this.pendingBreakthroughSpawnLinks[i];
        ...
        updateWaveBannerDebugTint(wave) {
          ...
          if (!node) return;
          var aggressive = wave.isForwardMode() && wave.isAggressiveForwardMode();

          if (this.waveBannerAggressiveTintCache.get(node) === aggressive) {
            return;
          }

          var tint = aggressive ? this.aggressiveWaveBannerTintParams : this.normalWaveBannerTintParams;
          var renderers = this.getWaveBannerRenderers(node);
        ...
        handleHeroDeath(unit) {
          var team = unit.team; // Capture the tactical state while the hero is still registered,
        ...
        captureHeroSpawnPosition(entry) {
          var node = entry == null ? void 0 : entry.heroNode;
        ...
        restoreHeroSpawnPosition(entry) {
          var node = entry.heroNode;
          var position = node ? this.heroSpawnPositions.get(node) : null;
        ...
        updateHeroLineIndicator(team, lineZ) {
          var indicator = team === 0 ? this.blueHeroLine : this.redHeroLine;
          if (!indicator) return;
          var position = indicator.worldPosition.clone();
        ...
        getHeroSupportLaneSelection(team) {
          var fallbackLaneId = this.getHeroLaneId();
          var laneCount = this.getSafeLaneCount();
          var unitsPerLane = new Array(laneCount).fill(0);
          ...
          for (var i = 0; i < units.length; i++) {
            ...
            var laneId = wave ? this.clampLaneId(wave.laneId) : this.getNearestLaneIdForX(unit.node.worldPosition.x);
          ...
          var selectedLaneId = fallbackLaneId;
          var mostUnits = unitsPerLane[fallbackLaneId] || 0;

          for (var _laneId = 0; _laneId < laneCount; _laneId++) {
            if (unitsPerLane[_laneId] > mostUnits) {
              selectedLaneId = _laneId;
              mostUnits = unitsPerLane[_laneId];
            }
          }
      ...
      }), _descriptor28 = _applyDecoratedDescriptor(_class2.prototype, "redHeroLine", [_dec24], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor29 = _applyDecoratedDescriptor(_class2.prototype, "blueHeroLine", [_dec25], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor30 = _applyDecoratedDescriptor(_class2.prototype, "updateInterval", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor31 = _applyDecoratedDescriptor(_class2.prototype, "rvoUpdateFrameOffset", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor32 = _applyDecoratedDescriptor(_class2.prototype, "maxRvoStepDeltaTime", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor33 = _applyDecoratedDescriptor(_class2.prototype, "visualSmooth", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor34 = _applyDecoratedDescriptor(_class2.prototype, "spatialGridCellSize", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor35 = _applyDecoratedDescriptor(_class2.prototype, "spatialGridUpdateInterval", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor36 = _applyDecoratedDescriptor(_class2.prototype, "spatialGridUpdateFrameOffset", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor37 = _applyDecoratedDescriptor(_class2.prototype, "useWorkerSpatialTargetQuery", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor38 = _applyDecoratedDescriptor(_class2.prototype, "teamAAliveLabel", [_dec26], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor39 = _applyDecoratedDescriptor(_class2.prototype, "teamADeathLabel", [_dec27], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor40 = _applyDecoratedDescriptor(_class2.prototype, "teamBAliveLabel", [_dec28], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor41 = _applyDecoratedDescriptor(_class2.prototype, "teamBDeathLabel", [_dec29], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor42 = _applyDecoratedDescriptor(_class2.prototype, "teamAKillLabel", [_dec30], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor43 = _applyDecoratedDescriptor(_class2.prototype, "teamBKillLabel", [_dec31], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor44 = _applyDecoratedDescriptor(_class2.prototype, "teamACounterKillLabel", [_dec32], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor45 = _applyDecoratedDescriptor(_class2.prototype, "teamBCounterKillLabel", [_dec33], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor46 = _applyDecoratedDescriptor(_class2.prototype, "teamACombatPointLabel", [_dec34], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor47 = _applyDecoratedDescriptor(_class2.prototype, "teamBCombatPointLabel", [_dec35], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor48 = _applyDecoratedDescriptor(_class2.prototype, "enableAutoSpawn", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor49 = _applyDecoratedDescriptor(_class2.prototype, "spawnImmediatelyOnStart", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor50 = _applyDecoratedDescriptor(_class2.prototype, "prewarmOnStart", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor51 = _applyDecoratedDescriptor(_class2.prototype, "spawnWaveInterval", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor52 = _applyDecoratedDescriptor(_class2.prototype, "maxAutoSpawnDeltaTime", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor53 = _applyDecoratedDescriptor(_class2.prototype, "teamASpawnZ", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor54 = _applyDecoratedDescriptor(_class2.prototype, "teamBSpawnZ", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor55 = _applyDecoratedDescriptor(_class2.prototype, "formationZNoise", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor56 = _applyDecoratedDescriptor(_class2.prototype, "centerGapWidth", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor57 = _applyDecoratedDescriptor(_class2.prototype, "enableLaneSpawn", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor58 = _applyDecoratedDescriptor(_class2.prototype, "laneCount", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor59 = _applyDecoratedDescriptor(_class2.prototype, "defaultSpawnLane", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor60 = _applyDecoratedDescriptor(_class2.prototype, "autoSpawnRandomLane", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor61 = _applyDecoratedDescriptor(_class2.prototype, "waveBannerRefreshIntervalFrames", [_dec36], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor62 = _applyDecoratedDescriptor(_class2.prototype, "waveBannerCamera", [_dec37], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor63 = _applyDecoratedDescriptor(_class2.prototype, "enableWaveBannerCameraVisibility", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor64 = _applyDecoratedDescriptor(_class2.prototype, "hideWaveBannerInOrbitMode", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor65 = _applyDecoratedDescriptor(_class2.prototype, "waveBannerHideFovBelow", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor66 = _applyDecoratedDescriptor(_class2.prototype, "waveBannerShowFovAbove", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor67 = _applyDecoratedDescriptor(_class2.prototype, "circleObstacles", [_dec38], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor68 = _applyDecoratedDescriptor(_class2.prototype, "rectObstacles", [_dec39], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
