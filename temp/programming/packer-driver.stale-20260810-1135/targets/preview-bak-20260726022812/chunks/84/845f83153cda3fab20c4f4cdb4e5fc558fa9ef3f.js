  ...
  return {
    ...
    execute: function () {
      ...
      _export("BattleArmyBrain", BattleArmyBrain = (_dec = ccclass('BattleArmyBrain'), _dec2 = property(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
        ...
        tooltip: 'Maximum Archer/Monk support waves allowed near one target lane. BattlefieldEvaluator uses decision accuracy and enemy ranged count to decide how much of this cap is available.'
      }), _dec10 = property({
        min: 1,
